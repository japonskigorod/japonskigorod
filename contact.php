  ...
  <body>
    ...
    <header role="banner">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand absolute" href="index.php">osteochondrosis</a>
        ...
        <div class="row">
          <div class="col-md-6 mb-5 order-2">
            ...
            <form class="" action="thanks.php" method="post">
              ...
              <div class="form-group">
                <input type="text" class="form-control" id="contact-lastname" placeholder="Nama keluarga">
              </div>
              <div class="form-group">
                <input type="email" class="form-control" id="contact-email" placeholder="Email">
              </div>
              <div class="form-group">
                <input type="email" class="form-control" id="contact-phone" placeholder="Nomor telepon">
              </div>
              <div class="form-group">
                <textarea class="form-control" name="message" id="message" cols="30" rows="10" placeholder="Teks komentar"></textarea>
                <label class="terms-field">
                  <input type="checkbox" name="terms" value="check" required=""/>
                  <a href="policy.php" target="_blank">
                    Saya telah membaca dan setuju dengan ketentuan perjanjian pengguna
                  </a>
                </label>
              </div>
            ...
            <div class="row justify-content-right">
              <div class="col-md-8 mx-auto contact-form-contact-info">
                <p class="d-flex">
                  ...
                  <span>Dk. Gegerkalong Hilir No. 990, Bandar Lampung 49851, DIY</span>
                </p>

                <p class="d-flex">
                  <span class="ion-ios-telephone icon mr-5"></span>
                  <span>+7738967534560</span>
                </p>

                <p class="d-flex">
                  <span class="ion-android-mail icon mr-5"></span>
                  <span>info.contact@<span class="server-name"></span></span>
                </p>
              </div>
            </div>
          </div>
